    ...
    <body>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <center><h1 style="font-weight: bold;">Student Detail</h1></center>
        <div class="col-xs-12">
            ...
            <table class="table table-striped" style="margin-top: 30px;">
                ...
                <tbody>
                    <?php 
                        $no = 1;
                        if (count($rs)==0) {
                            echo "<tr><td colspan='5' align='center'>---Don't Have Student In Your Catalog.----</td></tr>";
                        }else{
                            foreach ($rs as $r) {
                                echo "<tr>";
                                ...
                                echo "<td><button type='button' class='btn btn-info' data-toggle='modal' data-target='#myModaldetail".$r['student_id']."'>Detail</button></td>";
                                echo "<td>";
                                echo "<div class='modal fade' id='myModaldetail".$r['student_id']."' role='dialog'>
                                        <div class='modal-dialog'>
                                          <div class='modal-content'>
                                            ...
                                            <div class='modal-body'style='padding:0px 50px;'>
                                                <div class='col-lg-12'>
                                                    <div class='col-lg-6'>
                                                        <img src='".base_url()."images/student/".$r['stu_pic']."' style='width: 150px; height: auto;margin-top: 50%'>
                                                    </div>
                                                    <div class='col-lg-6'>
                    ...
                    <div class="col-lg-12">
                        <div class="col-lg-12" style="margin-top: 40px">
                            <ol class="breadcrumb">
                                ...
                                <li><a href="<?=base_url()?>"> www.ilmitutor.com</li></a>
